...
class RecordsView(IView):
    ...
    def _initialize_colors(self):
        ...
        # Выделение для хороших результатов
        curses.init_pair(3, curses.COLOR_YELLOW, curses.COLOR_BLACK)
        # Выделение для средних результатов
        curses.init_pair(4, curses.COLOR_RED, curses.COLOR_BLACK)
        # Выделение для плохих результатов
    ...
    def draw(self, window: curses.window):
        ...
        headers = ["Дата", "Язык", "Сложность",
                   "Уровень", "WPM", "Точность", "Завершено"]
        ...
        if not self.records:
            ...
            visible_records = display_records[
    ...
    def get_max_visible_records(self, window_height):
        ...
        """
        # 7 = 2 (заголовок) + 1 (шапка таблицы) + 1
        # (разделитель) + 3 (нижняя информация)
